// Credit to https://github.com/Yash-Handa/logo-ls for this icon map.
package icons
...
func GetIcon(file string) string {
	...
	return render(defaults["file"])
}

func GetDirectoryIcon() string {
	return render(defaults["dir"])
}

func render(i *Icon) string {
	return i.GetColor(1) + i.GetGlyph() + "\033[0m"
}

func (i *Icon) GetGlyph() string {
	return i.i
}

func (i *Icon) GetColor(f uint8) string {
	if i.e {
...
var icons = map[string]*Icon{
	...
	"yml":              {i: "\ue60b", c: [3]uint8{244, 68, 62}},   // yaml
	...
	"py":               {i: "\uf81f", c: [3]uint8{52, 102, 143}},  // python
